...
function Calendar(element, instanceOptions) {
	...
	function clearEvents() {
		...
		currentView.clearEventData(); // for qiantai.js, TODO: unify with clearEvents
	}
...
function DayEventRenderer() {
	...
	function renderDayEvents(events, modifiedEventId) {
		...
		// report the elements to the qiantai, for general drag/resize utilities
	...
	// A "segment" is the same data structure that qiantai.rangeToSegments produces,
