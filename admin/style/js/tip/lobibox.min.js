...
!function () {
    ...
    Lobibox.base = {}, Lobibox.base.OPTIONS = {
        ...
        buttons: {
            ...
            look: {"class": "lobibox-btn lobibox-btn-default", text: "我的货源", closeOnClick: !0},
            conti: {"class": "lobibox-btn lobibox-btn-yes", text: "继续发布", closeOnClick: !0}
        }
        ...
        _processInput: function (options) {
            ...
            return mergedOptions.buttons = {
                ...
                look: Lobibox.base.OPTIONS.buttons.look,
                conti: Lobibox.base.OPTIONS.buttons.conti,
...
!function () {
    var LobiboxNotify = function (type, options) {
        ...
        var me = this, _processInput = function (options) {
            ...
            var notify = $('<div class="lobibox-notify"></div>').addClass(Lobibox.notify.OPTIONS[me.$type]["class"]).addClass(Lobibox.notify.OPTIONS["class"]).addClass(me.$options.showClass), iconWrapper = $('<div class="lobibox-notify-icon"></div>').appendTo(notify);
            if (me.$options.img) {
        ...
        this.remove = function () {
            ...
            var parent = me.$el.parent(), wrapper = parent.closest(".lobibox-notify-wrapper-large"), href = "#" + parent.attr("id"), $li = wrapper.find('>.nav-tabs>li:has(a[href="' + href + '"])');
